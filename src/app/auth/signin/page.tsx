                        ...
                        <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
                            ...
                            >
                                <div className="bg-white p-1 rounded-full">
                                    <img className="w-4" src="/images/logo/google.svg" alt="Google logo" />
                                </div>
                                <span className="ml-4" onClick={() => handleLogin("google")}>
                                    Sign Up with Google
                                </span>
                            </button>

                            <button
                                className="w-full max-w-xs font-bold shadow-sm rounded-lg py-3 bg-indigo-100 text-gray-800 flex items-center justify-center transition-all duration-300 ease-in-out focus:outline-none hover:shadow focus:shadow-sm focus:shadow-outline mt-5 disabled:opacity-60"
                                disabled={loading}
                            >
                                <div className="bg-white p-1 rounded-full">
                                    <img className="w-4" src="/images/logo/facebook.svg" alt="Facebook logo" />
                                </div>
                                <span className="ml-4" onClick={() => handleLogin("facebook")}>
